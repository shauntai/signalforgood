            ...
            <div className="max-w-3xl mx-auto">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="https://github.com/shauntai/signalforgood/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:underline">
